...
func (e *FileUploadAndDownloadRouter) InitFileUploadAndDownloadRouter(Router *gin.RouterGroup, PublicGroup *gin.RouterGroup) {
	fileUploadAndDownloadRouter := Router.Group("fileUploadAndDownload")
	fileUploadAndDownloadRouterWithoutAuth := PublicGroup.Group("fileUploadAndDownload")
	{
	...
	{
		fileUploadAndDownloadRouterWithoutAuth.POST("upload", exaFileUploadAndDownloadApi.UploadFile) // Tải lên tệp (công khai, không cần xác thực)
	}
}
