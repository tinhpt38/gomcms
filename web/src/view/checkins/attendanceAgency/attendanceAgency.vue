  ...
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="Ngày" prop="createdAt" width="180">
          ...
          <el-table-column align="left" label="Đơn vị" prop="name" width="120" />
        ...
        <el-table-column align="left" label="Hành động" fixed="right" min-width="240">
            ...
            <el-button  type="primary" link icon="edit" class="table-button" @click="updateAttendanceAgencyFunc(scope.row)">Chỉnh sửa</el-button>
