  ...
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="Ngày" prop="createdAt" width="180">
          ...
          <el-table-column align="left" label="Tên phân loại" prop="name" width="120" />
        ...
        <el-table-column align="left" label="Hành động" fixed="right" min-width="240">
            ...
            <el-button  type="primary" link icon="edit" class="table-button" @click="updateAttendanceCategoryFunc(scope.row)">Chỉnh sửa</el-button>
    ...
    <el-drawer destroy-on-close size="800" v-model="dialogFormVisible" :show-close="false" :before-close="closeDialog">
       <template #header>
          ...
          <el-form :model="formData" label-position="top" ref="elFormRef" :rules="rule" label-width="80px">
            <el-form-item label="Tên phân loại:"  prop="name" >
              <el-input v-model.number="formData.name" :clearable="true" placeholder="Nhập tên phân loại" />
            </el-form-item>
