                ...
                <div class="flex h-16 items-center justify-between">
                  ...
                  <div class="hidden lg:flex lg:items-center">
                    <a href="#">
                      ...
                      <!-- <img class="h-8 w-auto" src="/img/logos/mark.svg?color=indigo&shade=600" alt="" /> -->
                    </a>
                  </div>
                  ...
                  <a href="#" class="lg:hidden">
                    <span class="sr-only">Your Company</span>
                    <!-- <img src="/img/logos/mark.svg?color=indigo&shade=600" alt="" class="h-8 w-auto" /> -->
                  </a>
        ...
        <div class="flex flex-col border-b border-gray-200 lg:border-0">
          ...
          <div class="relative">
            ...
            <div class="h-48 w-full sm:h-64 lg:absolute lg:right-0 lg:top-0 lg:h-full lg:w-1/2">
              <!-- <img src="/img/ecommerce-images/home-page-02-hero-half-width.jpg" alt="" class="h-full w-full object-cover object-center" /> -->
            </div>
          </div>
        </div>
        ...
        <div class="relative overflow-hidden">
          ...
          <div aria-hidden="true" class="absolute inset-0">
            <div class="absolute inset-0 mx-auto max-w-7xl overflow-hidden xl:px-8">
              <!-- <img src="/img/ecommerce-images/home-page-02-sale-full-width.jpg" alt="" class="h-full w-full object-cover object-center" /> -->
            </div>
            ...
            <div class="lg:grid lg:grid-cols-2 lg:gap-x-6 xl:gap-x-8">
              ...
              <div class="relative mt-6 flex items-center px-6 py-12 sm:px-10 sm:py-16 lg:mt-0">
                <div class="absolute inset-0 overflow-hidden rounded-lg">
                  <!-- <img src="/img/ecommerce-images/footer-02-exclusive-sale.jpg" alt="" class="h-full w-full object-cover object-center saturate-0 filter" /> -->
            ...
            <div class="mt-4 flex items-center justify-center md:mt-0">
              ...
              <div class="ml-6 border-l border-gray-200 pl-6">
                <a href="#" class="flex items-center text-gray-500 hover:text-gray-600">
                  <!-- <img src="/img/flags/flag-canada.svg" alt="" class="h-auto w-5 flex-shrink-0" /> -->
  ...
  const trendingProducts = [
    {
      ...
      price: '$35',
      href: '#',
      imageSrc: '/img/ecommerce-images/home-page-02-product-01.jpg',
  ...
  const collections = [
    {
      ...
      imageSrc: '/img/ecommerce-images/home-page-02-edition-01.jpg',
    ...
    },
    {
      ...
      imageSrc: '/img/ecommerce-images/home-page-02-edition-02.jpg',
    ...
    },
    {
      ...
      imageSrc: '/img/ecommerce-images/home-page-02-edition-03.jpg',
