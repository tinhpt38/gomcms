  ...
  <div>
    <div class="gva-search-box">
      ...
      <el-date-picker v-model="searchInfo.endCreatedAt" type="datetime" placeholder="结束日期" :disabled-date="time=> searchInfo.startCreatedAt ? time.getTime() < searchInfo.startCreatedAt.getTime() : false"></el-date-picker>
        ...
        <el-form-item label="Mã định danh quá trình xử lý tệp tin" prop="fileProcessId">
             ...
             <el-input v-model.number="searchInfo.fileProcessId" placeholder="搜索条件" />

        </el-form-item>
        <el-form-item label="Cột dữ liệu " prop="fieldTitle">
         <el-input v-model="searchInfo.fieldTitle" placeholder="搜索条件" />
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="日期" prop="createdAt" width="180">
          ...
          <el-table-column align="left" label="Mã định danh quá trình xử lý tệp tin" prop="fileProcessId" width="120" />
          <el-table-column align="left" label="Mã định danh của tệp tin" prop="fileProcessUuid" width="120" />
        ...
        <el-table-column align="left" label="操作" fixed="right" min-width="240">
            ...
            <el-button  type="primary" link icon="edit" class="table-button" @click="updateFileProcessErrorFunc(scope.row)">变更</el-button>
    ...
    <el-drawer destroy-on-close size="800" v-model="dialogFormVisible" :show-close="false" :before-close="closeDialog">
       <template #header>
          ...
          <el-form :model="formData" label-position="top" ref="elFormRef" :rules="rule" label-width="80px">
            <el-form-item label="Mã định danh quá trình xử lý tệp tin:"  prop="fileProcessId" >
              <el-input v-model.number="formData.fileProcessId" :clearable="true" placeholder="请输入Mã định danh quá trình xử lý tệp tin" />
            </el-form-item>
    ...
    <el-drawer destroy-on-close size="800" v-model="detailShow" :show-close="true" :before-close="closeDetailShow">
            <el-descriptions column="1" border>
                    <el-descriptions-item label="Mã định danh quá trình xử lý tệp tin">
